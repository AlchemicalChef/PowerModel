defmodule PowerModel.Ingestion.Water.SanDiego do
  ...
  # ── Key San Diego County Water Facilities ──────────────────────────────
  # Coordinates and capacities from public SDCWA reports, city websites,
  # EPA ECHO database, and CEQA filings.
  ...
  @carlsbad_facilities [
    %{
      ...
      city: "Carlsbad", county: "San Diego", owner: "Poseidon Water",
      capacity_mgd: 50.0, power_consumption_mw: 38.0,
      source: "sdcwa", source_id: "carlsbad_desal"
    },
    %{
      name: "Encina Water Pollution Control Facility",
      facility_type: "wastewater",
      coordinates: {-117.3210, 33.1170},
      city: "Carlsbad", county: "San Diego", owner: "Encina Wastewater Authority",
      capacity_mgd: 36.0, power_consumption_mw: 4.5,
      source: "epa", source_id: "encina_wpcf"
    },
    %{
      name: "Carlsbad Water Recycling Facility",
      facility_type: "treatment",
      coordinates: {-117.3185, 33.1195},
      city: "Carlsbad", county: "San Diego", owner: "City of Carlsbad",
      capacity_mgd: 4.2, power_consumption_mw: 0.8,
      source: "carlsbad", source_id: "carlsbad_wrf"
    },
  ]
  ...
  @sdcwa_facilities [
    ...
    %{
      ...
      city: "San Marcos", county: "San Diego", owner: "SDCWA",
      capacity_mgd: 100.0, power_consumption_mw: 8.0,
      source: "sdcwa", source_id: "twin_oaks_wtp"
    },
    %{
      name: "Robert A. Perdue Water Treatment Plant",
      facility_type: "treatment",
      coordinates: {-117.0270, 32.8860},
      city: "Lakeside", county: "San Diego", owner: "Helix Water District",
      capacity_mgd: 106.0, power_consumption_mw: 6.0,
      source: "sdcwa", source_id: "perdue_wtp"
    },
    %{
      name: "Miramar Water Treatment Plant",
      facility_type: "treatment",
      coordinates: {-117.1090, 32.8910},
      city: "San Diego", county: "San Diego", owner: "City of San Diego",
      capacity_mgd: 215.0, power_consumption_mw: 12.0,
      source: "sdcwa", source_id: "miramar_wtp"
    },
    %{
      ...
      city: "San Diego", county: "San Diego", owner: "City of San Diego",
      capacity_mgd: 200.0, power_consumption_mw: 10.0,
      source: "sdcwa", source_id: "alvarado_wtp"
    },
    %{
      name: "Otay Water Treatment Plant",
      facility_type: "treatment",
      coordinates: {-116.9370, 32.6270},
      city: "Chula Vista", county: "San Diego", owner: "City of San Diego",
      capacity_mgd: 34.0, power_consumption_mw: 3.0,
      source: "sdcwa", source_id: "otay_wtp"
    },
    ...
    %{
      ...
      city: "San Diego", county: "San Diego", owner: "City of San Diego",
      capacity_mgd: 175.0, power_consumption_mw: 15.0,
      source: "sdcwa", source_id: "point_loma_wwtp"
    },
    %{
      ...
      city: "San Diego", county: "San Diego", owner: "City of San Diego",
      capacity_mgd: 30.0, power_consumption_mw: 4.0,
      source: "sdcwa", source_id: "north_city_wrp"
    },
    %{
      ...
      city: "San Diego", county: "San Diego", owner: "City of San Diego",
      capacity_mgd: 15.0, power_consumption_mw: 2.5,
      source: "sdcwa", source_id: "south_bay_wrp"
    },
    %{
      name: "Hale Avenue Resource Recovery Facility",
      facility_type: "wastewater",
      coordinates: {-117.1110, 33.1050},
      city: "Escondido", county: "San Diego", owner: "City of Escondido",
      capacity_mgd: 18.0, power_consumption_mw: 2.5,
      source: "sdcwa", source_id: "harrf"
    },
    %{
      name: "San Elijo Water Reclamation Facility",
      facility_type: "wastewater",
      coordinates: {-117.2770, 33.0070},
      city: "Cardiff", county: "San Diego", owner: "San Elijo JPA",
      capacity_mgd: 5.25, power_consumption_mw: 1.2,
      source: "sdcwa", source_id: "san_elijo_wrf"
    },
    %{
      name: "Oceanside Water Reclamation Facility",
      facility_type: "wastewater",
      coordinates: {-117.3700, 33.1800},
      city: "Oceanside", county: "San Diego", owner: "City of Oceanside",
      capacity_mgd: 14.0, power_consumption_mw: 2.0,
      source: "sdcwa", source_id: "oceanside_wrf"
    },
    %{
      name: "Padre Dam Water Recycling Facility",
      facility_type: "wastewater",
      coordinates: {-116.9530, 32.8550},
      city: "Santee", county: "San Diego", owner: "Padre Dam MWD",
      capacity_mgd: 3.6, power_consumption_mw: 0.8,
      source: "sdcwa", source_id: "padre_dam_wrf"
    },
    ...
    %{
      ...
      city: "Encinitas", county: "San Diego", owner: "SDCWA",
      storage_acre_feet: 24_000.0,
      source: "sdcwa", source_id: "olivenhain_res"
    },
    %{
      name: "San Vicente Reservoir",
      facility_type: "reservoir",
      coordinates: {-116.9170, 32.9100},
      city: "Lakeside", county: "San Diego", owner: "City of San Diego",
      storage_acre_feet: 242_000.0,
      source: "sdcwa", source_id: "san_vicente_res"
    },
    %{
      ...
      source: "sdcwa", source_id: "el_capitan_res"
    },
    %{
      name: "Lake Hodges",
      facility_type: "reservoir",
      coordinates: {-117.1050, 33.0640},
      city: "Escondido", county: "San Diego", owner: "City of San Diego",
      storage_acre_feet: 30_251.0,
      source: "sdcwa", source_id: "lake_hodges"
    },
    %{
      name: "Sweetwater Reservoir",
      facility_type: "reservoir",
      coordinates: {-116.9780, 32.6840},
      city: "Spring Valley", county: "San Diego", owner: "Sweetwater Authority",
      storage_acre_feet: 28_079.0,
      source: "sdcwa", source_id: "sweetwater_res"
    },
    %{
      name: "Otay Reservoir",
      facility_type: "reservoir",
      ...
      source: "sdcwa", source_id: "otay_res"
    },
    %{
      name: "Lake Murray",
      facility_type: "reservoir",
      coordinates: {-117.0400, 32.7840},
      city: "La Mesa", county: "San Diego", owner: "City of San Diego",
      storage_acre_feet: 4_684.0,
      source: "sdcwa", source_id: "lake_murray"
    },
    %{
      ...
      source: "sdcwa", source_id: "miramar_res"
    },

    # Pump stations (SDCWA aqueduct system)
    %{
      ...
      source: "sdcwa", source_id: "twin_oaks_ps"
    },
    %{
      ...
      source: "sdcwa", source_id: "vallecitos_ps"
    },
    %{
      name: "Rancho Bernardo Pump Station",
      facility_type: "pump_station",
      coordinates: {-117.0840, 33.0140},
      city: "San Diego", county: "San Diego", owner: "SDCWA",
      power_consumption_mw: 2.0,
      source: "sdcwa", source_id: "rancho_bernardo_ps"
    },
    %{
      name: "Lake Hodges Pump Station",
      facility_type: "pump_station",
      coordinates: {-117.1200, 33.0670},
      city: "Escondido", county: "San Diego", owner: "Olivenhain MWD",
      power_consumption_mw: 4.0,
      source: "sdcwa", source_id: "lake_hodges_ps"
    },
    %{
      ...
      source: "sdcwa", source_id: "san_vicente_ps"
    },
  ]
  ...
  defp insert_facilities(facilities) do
    ...
    |> Enum.reduce(0, fn attrs, count ->
      ...
      case Repo.insert_all(WaterFacility, [entry],
             on_conflict: :nothing,
             conflict_target: [:source, :source_id]) do
        {1, _} -> count + 1
        _ -> count
      end
    end)
      ...
      {:ok, %{status: 200, body: %{"features" => features}}} ->
        ...
        |> Enum.reduce(0, fn feature, count ->
          ...
          if geom && geom["x"] && geom["y"] do
            ...
            facility_type = case attrs["CWP_FACILI"] do
              "POTW" -> "wastewater"
              _ -> "wastewater"
            end
