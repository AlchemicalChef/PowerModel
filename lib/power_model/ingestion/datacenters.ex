defmodule PowerModel.Ingestion.Datacenters do
  ...
  @campuses [
    ...
    {"AWS Ashburn (US-East-1)", "Amazon Web Services", "hyperscale", "Ashburn", "VA", -77.487, 39.045, 800.0},
    {"AWS Manassas", "Amazon Web Services", "hyperscale", "Manassas", "VA", -77.52, 38.78, 400.0},
    {"AWS Chantilly", "Amazon Web Services", "hyperscale", "Chantilly", "VA", -77.44, 38.89, 300.0},
    {"Equinix Ashburn Campus", "Equinix", "colocation", "Ashburn", "VA", -77.46, 39.015, 300.0},
    {"Digital Realty Ashburn", "Digital Realty", "colocation", "Ashburn", "VA", -77.45, 39.02, 250.0},
    ...
    {"STACK Ashburn", "STACK Infrastructure", "colocation", "Ashburn", "VA", -77.42, 39.02, 200.0},
    ...
    {"Google Moncks Corner", "Google", "hyperscale", "Moncks Corner", "SC", -80.013, 33.196, 300.0},
    {"Google Douglas County", "Google", "hyperscale", "Lithia Springs", "GA", -84.58, 33.74, 350.0},
    ...
    # ── Texas ─────────────────────────────────────────────────────────────
    {"Microsoft San Antonio", "Microsoft", "hyperscale", "San Antonio", "TX", -98.38, 29.42, 400.0},
    ...
    {"Digital Realty Richardson", "Digital Realty", "colocation", "Richardson", "TX", -96.70, 32.99, 200.0},
    {"Stargate Abilene", "OpenAI / Crusoe", "ai_training", "Abilene", "TX", -99.78, 32.41, 600.0},

    # ── Ohio / Midwest ────────────────────────────────────────────────────
    {"AWS New Albany (US-East-2)", "Amazon Web Services", "hyperscale", "New Albany", "OH", -82.79, 40.08, 600.0},
    ...
    {"Equinix Elk Grove Village", "Equinix", "colocation", "Elk Grove Village", "IL", -87.99, 42.00, 150.0},
    {"Meta DeKalb", "Meta", "hyperscale", "DeKalb", "IL", -88.71, 41.93, 300.0},

    # ── Iowa / Nebraska / Oklahoma / Wyoming ──────────────────────────────
    {"Google Council Bluffs", "Google", "hyperscale", "Council Bluffs", "IA", -95.862, 41.221, 900.0},
    {"Meta Altoona", "Meta", "hyperscale", "Altoona", "IA", -93.474, 41.649, 500.0},
    {"Microsoft West Des Moines", "Microsoft", "hyperscale", "West Des Moines", "IA", -93.78, 41.56, 450.0},
    ...
    {"Switch Citadel", "Switch", "colocation", "Tahoe Reno Industrial Center", "NV", -119.44, 39.54, 350.0},
    ...
    {"NSA Utah Data Center", "US Government", "enterprise", "Bluffdale", "UT", -111.934, 40.426, 65.0},
    ...
    {"AWS Boardman (US-West-2)", "Amazon Web Services", "hyperscale", "Boardman", "OR", -119.70, 45.84, 700.0},
  ...
  def ingest do
    ...
    {count, _} =
      Repo.insert_all(Datacenter, entries,
        on_conflict:
          {:replace, [:operator, :facility_type, :coordinates, :city, :state, :power_mw, :updated_at]},
