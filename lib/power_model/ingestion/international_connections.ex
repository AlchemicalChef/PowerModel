defmodule PowerModel.Ingestion.InternationalConnections do
  ...
  # -----------------------------------------------------------------------
  # Known international tie lines
  #
  # Each entry:
  #   name           – human-readable label
  #   us_coords      – {lon, lat} on the US side
  #   foreign_coords – {lon, lat} on the Canadian/Mexican side
  #   voltage_kv     – nominal voltage
  #   rating_mva     – thermal/transfer limit
  #   country        – "CA" or "MX"
  #   region         – foreign region name (province/state)
  #   interconnection – which US interconnection it belongs to
  #   x_pu           – approximate per-unit reactance
  # -----------------------------------------------------------------------
  ...
  @us_canada_ties [
    ...
    %{
      ...
      us_coords: {-72.02, 44.97},
      foreign_coords: {-72.02, 45.02},
      voltage_kv: 120.0,
      rating_mva: 225.0,
      country: "CA",
      region: "Quebec",
    ...
    %{
      ...
      us_coords: {-72.13, 44.98},
      foreign_coords: {-72.13, 45.01},
      voltage_kv: 120.0,
      rating_mva: 100.0,
      country: "CA",
      region: "Quebec",
    ...
    %{
      ...
      us_coords: {-74.89, 44.93},
      foreign_coords: {-74.10, 45.35},
      voltage_kv: 765.0,
      rating_mva: 1800.0,
      country: "CA",
      region: "Quebec",
    ...
    %{
      ...
      us_coords: {-79.06, 43.09},
      foreign_coords: {-79.08, 43.11},
      voltage_kv: 345.0,
      rating_mva: 1500.0,
      country: "CA",
      region: "Ontario",
    ...
    %{
      ...
      us_coords: {-76.02, 44.31},
      foreign_coords: {-76.02, 44.37},
      voltage_kv: 115.0,
      rating_mva: 150.0,
      country: "CA",
      region: "Ontario",
    ...
    %{
      ...
      us_coords: {-82.42, 42.60},
      foreign_coords: {-82.42, 42.98},
      voltage_kv: 345.0,
      rating_mva: 1200.0,
      country: "CA",
      region: "Ontario",
    ...
    %{
      ...
      us_coords: {-83.04, 42.33},
      foreign_coords: {-83.04, 42.31},
      voltage_kv: 230.0,
      rating_mva: 400.0,
      country: "CA",
      region: "Ontario",
    ...
    %{
      ...
      us_coords: {-96.82, 48.99},
      foreign_coords: {-97.15, 49.88},
      voltage_kv: 500.0,
      rating_mva: 1850.0,
      country: "CA",
      region: "Manitoba",
    ...
    %{
      ...
      us_coords: {-93.41, 48.60},
      foreign_coords: {-99.33, 49.18},
      voltage_kv: 230.0,
      rating_mva: 300.0,
      country: "CA",
      region: "Manitoba",
    ...
    %{
      ...
      us_coords: {-97.23, 48.60},
      foreign_coords: {-97.23, 49.00},
      voltage_kv: 230.0,
      rating_mva: 250.0,
      country: "CA",
      region: "Manitoba",
    ...
    %{
      ...
      us_coords: {-103.97, 48.99},
      foreign_coords: {-104.98, 49.01},
      voltage_kv: 230.0,
      rating_mva: 150.0,
      country: "CA",
      region: "Saskatchewan",
    ...
    %{
      ...
      us_coords: {-67.78, 45.04},
      foreign_coords: {-66.45, 45.07},
      voltage_kv: 345.0,
      rating_mva: 1000.0,
      country: "CA",
    ...
    %{
      ...
      us_coords: {-67.55, 45.19},
      foreign_coords: {-67.28, 45.20},
      voltage_kv: 138.0,
      rating_mva: 200.0,
      country: "CA",
      region: "New Brunswick",
    ...
    # ── British Columbia ↔ Pacific Northwest (Western) ───────────────
    %{
      name: "BC–WA 500kV (Ingledow–Custer)",
      us_coords: {-122.77, 48.96},
      foreign_coords: {-122.77, 49.15},
      voltage_kv: 500.0,
      rating_mva: 3150.0,
      country: "CA",
    ...
    %{
      ...
      us_coords: {-117.43, 48.99},
      foreign_coords: {-117.43, 49.01},
      voltage_kv: 230.0,
      rating_mva: 600.0,
      country: "CA",
      region: "British Columbia",
    ...
    %{
      ...
      us_coords: {-119.44, 48.99},
      foreign_coords: {-119.44, 49.10},
      voltage_kv: 230.0,
      rating_mva: 400.0,
      country: "CA",
      region: "British Columbia",
    ...
    # ── Alberta ↔ Montana (Western) ──────────────────────────────────
    %{
      name: "AB–MT 230kV (Lethbridge–Shelby)",
      us_coords: {-111.86, 48.99},
      foreign_coords: {-112.79, 49.70},
      voltage_kv: 230.0,
      rating_mva: 300.0,
      country: "CA",
      region: "Alberta",
    ...
    %{
      ...
      us_coords: {-110.00, 49.00},
      foreign_coords: {-110.00, 49.20},
      voltage_kv: 230.0,
      rating_mva: 300.0,
      country: "CA",
      region: "Alberta",
  ...
  @us_mexico_ties [
    ...
    %{
      ...
      us_coords: {-100.49, 28.71},
      foreign_coords: {-100.49, 28.69},
      voltage_kv: 138.0,
      rating_mva: 36.0,
      country: "MX",
      region: "Coahuila",
    ...
    %{
      ...
      us_coords: {-99.51, 27.51},
      foreign_coords: {-99.51, 27.49},
      voltage_kv: 138.0,
      rating_mva: 100.0,
      country: "MX",
      region: "Tamaulipas",
    ...
    %{
      ...
      us_coords: {-99.49, 27.50},
      foreign_coords: {-99.49, 27.48},
      voltage_kv: 138.0,
      rating_mva: 100.0,
      country: "MX",
      region: "Tamaulipas",
    ...
    %{
      ...
      us_coords: {-98.23, 26.20},
      foreign_coords: {-98.23, 26.18},
      voltage_kv: 138.0,
      rating_mva: 150.0,
      country: "MX",
      region: "Tamaulipas",
    ...
    %{
      ...
      us_coords: {-115.57, 32.72},
      foreign_coords: {-115.57, 32.66},
      voltage_kv: 230.0,
      rating_mva: 800.0,
      country: "MX",
    ...
    %{
      ...
      us_coords: {-116.94, 32.56},
      foreign_coords: {-116.94, 32.53},
      voltage_kv: 230.0,
      rating_mva: 400.0,
      country: "MX",
      region: "Baja California",
    ...
    %{
      ...
      us_coords: {-110.94, 31.34},
      foreign_coords: {-110.94, 31.30},
      voltage_kv: 345.0,
      rating_mva: 400.0,
      country: "MX",
      region: "Sonora",
  ...
  def run do
    ...
    IO.puts(
      "Created #{total} international tie lines (#{length(@us_canada_ties)} CA, #{length(@us_mexico_ties)} MX defined)."
    )
  ...
  defp create_tie_line(tie) do
    ...
    # Create or find boundary bus on US side
    ...
    # Create or find equivalent bus on foreign side
    foreign_source_id = "intl_#{String.downcase(tie.country)}_#{slug(tie.name)}"

    foreign_bus =
      ensure_bus(%{
        # PV — represents foreign grid equivalent
        bus_type: 2,
        base_kv: tie.voltage_kv,
    ...
    # Create equivalent generator at foreign bus (import capacity)
    ensure_generator(%{
      bus_id: foreign_bus.id,
      # 80% of thermal limit as import capacity
