defmodule PowerModel.Solver.IEEE14BusTest do
  ...
  describe "AC power flow on IEEE 14-bus" do
    ...
    test "real losses are computed and the energy balance closes", %{solution: sol} do
      # IEEE 14-bus real losses are ~13 MW; allow a generous sanity bound
      assert sol.total_loss_mw > 0.0
      assert sol.total_loss_mw < 25.0,
        "Losses #{sol.total_loss_mw} MW are implausibly high for IEEE 14-bus"
